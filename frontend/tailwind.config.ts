  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Custom palette
        "pink-orchid": "hsl(var(--pink-orchid))",
        "pastel-petal": "hsl(var(--pastel-petal))",
        "blush-pop": "hsl(var(--blush-pop))",
      ...
      boxShadow: {
        clinical: "0 2px 8px -2px rgba(0, 0, 0, 0.05), 0 4px 16px -4px rgba(0, 0, 0, 0.08)",
        "clinical-lg": "0 4px 12px -2px rgba(0, 0, 0, 0.06), 0 8px 24px -6px rgba(0, 0, 0, 0.1)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
